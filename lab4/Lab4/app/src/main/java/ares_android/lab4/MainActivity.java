...
public class MainActivity extends AppCompatActivity {
    ...
    private static ArrayList<Merchandise> shoplistdata = new ArrayList<>();
    private int Size = 10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(receivedata!=null) {
            ...
            tempMerchandise = (Merchandise)receivedata.getSerializable("AddItem");
            if(tempMerchandise!=null) {
                AddItemforShoplist(tempMerchandise);
                mAdapter2.updateData(getShoplistdata());
            }
        };
    ...
    private void recommand() {
        IntentFilter static_filter = new IntentFilter();
        static_filter.addAction("com.lab4.MyStaticFilter");
        myStaticReceiver = new MyStaticReceiver();
        registerReceiver(myStaticReceiver, static_filter);
